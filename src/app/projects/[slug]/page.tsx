  ...
  return (
    <>
      ...
      <PageHero
        ...
        meta={
          <dl className="mx-auto mt-8 grid max-w-2xl grid-cols-2 gap-x-8 gap-y-5 border-t border-line pt-7 sm:grid-cols-4">
            {[
              { label: "Location", value: project.location },
          ...
          <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
            <div className="lg:col-span-7">
              ...
              <TextReveal
                ...
                className="text-display-4 text-ink"
              />
            ...
            <div className="lg:col-span-5">
              <Reveal>
                <div className="border border-line bg-canvas-dim p-8 md:p-10 lg:sticky lg:top-28">
                  <p className="label text-muted">Project Details</p>
                  <dl className="mt-7 divide-y divide-line">
                    {factRows.map((row) => (
                      ...
                      >
                        <dt className="label shrink-0 text-ink/45">
                          {row.label}
                        </dt>
      ...
      <section className="border-t border-line bg-canvas-dim py-24 md:py-32">
        <Container>
          <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
            <div className="lg:col-span-5">
              <Reveal>
      ...
      <section className="border-t border-line bg-canvas py-20 md:py-28">
        <Container>
          <Reveal>
            <Eyebrow className="mb-5">Key Highlights</Eyebrow>
          </Reveal>
          <TextReveal
            text={"What makes this\nproject work."}
            className="max-w-2xl text-display-3 font-semibold text-ink"
          />

          <RevealGroup
            as="ul"
            stagger={0.08}
            className="mt-12 grid gap-x-10 gap-y-8 md:grid-cols-2 lg:grid-cols-3"
          >
            ...
            <Reveal>
              ...
              >
                <div>
                  ...
                  <p className="mt-4 text-display-3 text-ink transition-colors duration-500 group-hover:text-ink">
                    {next.name}
                  </p>
                ...
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[10px] border border-line text-ink transition-colors duration-500 group-hover:bg-ink group-hover:text-canvas">
